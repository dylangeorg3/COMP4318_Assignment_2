...
\begin{table}[H]
    ...
    \begin{tabular}{lccccl}
        ...
        \midrule
        SVM & 69.01 & 68.26 & 10.6 & 6.02 & $d=30$, $C=5.0$, $\gamma=0.001$ \\
        MLP & 34.51 & 29.47 & 22.2 & 0.33 & units$=128$, dropout$=0.0$, $\eta=1e-04$ \\
        CNN & 68.41 & 64.69 & 27.4 & 0.36 & filters$=16$, $k=5$, dropout$=0.3$, $\eta=1e-03$ \\
        \bottomrule
    \end{tabular}
\end{table}
